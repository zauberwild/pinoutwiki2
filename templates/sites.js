var articles = ["Afghanistan", "Albania", "Algeria", 
					...
					"Namibia", "Nauro", "Nepal", "Netherlands", 
					...
					"South Sudan", "Spain", "Sri Lanka", "St Kitts &amp; Nevis", 
					...
					"Vietnam", "Virgin Islands (US)", "Yemen", 
					"Zambia", "Zimbabwe"
];

var links = ["/communication busses/UART", "Albania", "Algeria", 
					"Andorra", "Angola", "Anguilla", 
					"Antigua &amp; Barbuda", "Argentina", 
					"Armenia", "Aruba", "Australia", "Austria", 
					"Azerbaijan", "Bahamas", "Bahrain", "Bangladesh", 
